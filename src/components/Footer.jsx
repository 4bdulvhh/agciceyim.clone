...
const Footer = () => {
  return (
    <footer className="w-full bg-gray-200 py-8 font-sans">
      <div className="bg-gray-200">
        <div className="text-center mb-12 bg-gray-200">
          <h2 className="text-2xl mb-4" style={{ fontFamily: "cursive" }}>
            Bizi izləyin
          </h2>
        ...
        <div className="border-t border-gray-200 pt-8 bg-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-500">
              © 2021-2025 Ağ Çiçeyim İgidəli tərəfindən yaradılıb
            </div>
