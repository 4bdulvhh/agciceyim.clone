...
const VipMehsullar = () => {
  ...
  useEffect(() => {
    // Get 15 random products from data
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        {products.length > itemsToShow && (
          <>
            ...
            <div className="flex-1 text-center">
              <h2 className="text-4xl mb-2 font-pacifico">VİP</h2>
      ...
      <div className="text-center mt-16">
        <button className="text-black hover:text-[#0CE6DF]/80 font-bold font-futura text-lg border-b-2 border-[#0CE6DF]  transition duration-300  pb-1">
          Bütün VIP məhsullar
        </button>
      </div>
    </div>
